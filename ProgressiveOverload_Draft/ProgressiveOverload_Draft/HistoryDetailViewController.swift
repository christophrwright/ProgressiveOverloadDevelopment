...
class HistoryDetailViewController: UIViewController, LineChartDelegate {
    ...
    override func viewDidLoad() {
        ...
        // simple arrays
        let data: [CGFloat] = [135,150,175,200,225]
        //let data2: [CGFloat] = [1, 3, 5, 13, 17, 20]
        
        // simple line with custom x axis labels
        let xLabels: [String] = ["Jan1","Jan15","Feb1", "Feb15", "Mar1", "Mar15"]
